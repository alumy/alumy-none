...
int_fast8_t ds1302_write_date_time(ds1302_t *this, const struct tm *tm)
{
    ...
    ds1302_write(this, 0x84, bin2bcd(tm->tm_hour) & 0x1F);
    ...
    ds1302_write(this, 0x8C, bin2bcd(tm->tm_year + 1900));
...
int_fast8_t ds1302_read_date_time(ds1302_t *this, struct tm *tm)
{
    ...
    tm->tm_hour = bcd2bin(ds1302_read(this, 0x85) & 0x1F);
    ...
    tm->tm_year = bcd2bin(ds1302_read(this, 0x8D));
