 ...
 */
static inline void list_add_tail(struct list_head *_new, struct list_head *_head)
{
 ...
 * the prev/next entries already!
 */
static inline void __list_del(struct list_head * _prev,
				  struct list_head * _next)
{
	_next->prev = _prev;
	_prev->next = _next;
 ...
 */
static inline void list_del(struct list_head *_entry)
{
 ...
 * @entry: the element to delete from the list.
 */
static inline void list_del_init(struct list_head *_entry)
{
	__list_del(_entry->prev, _entry->next);
 ...
 */
static inline int list_empty(const struct list_head *_head)
{
