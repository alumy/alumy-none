...
#ifndef __AL_BITOPS_GENERIC_NON_ATOMIC_H
#define __AL_BITOPS_GENERIC_NON_ATOMIC_H

#include "alumy/bits.h"

#ifndef __AL_BITOPS_BITS_PER_LONG_H
#error only <alumy/bitops/bitops.h> can be included directly
#endif
...
{
    unsigned long *p = ((unsigned long *)addr) + BIT_WORD(nr);
    return 1UL & (*p >> (nr & (BITS_PER_LONG-1)));
}
