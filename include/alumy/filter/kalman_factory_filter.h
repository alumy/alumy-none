...
*/
static al_kalman_t* KALMAN_FUNCTION_NAME(init)()
{
    int i;
    ...
    al_kalman_filter_init(&KALMAN_STRUCT_NAME, KALMAN_NUM_STATES, KALMAN_NUM_INPUTS, __KALMAN_BUFFER_A, __KALMAN_BUFFER_x,
